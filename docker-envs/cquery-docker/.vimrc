...
" vim-lsp vim-lsp-query
autocmd FileType c,cc,cpp,cxx,h,hpp nnoremap <leader>fD :LspDeclaration<CR>
autocmd FileType c,cc,cpp,cxx,h,hpp nnoremap <leader>fG :LspDefinition<CR>
autocmd FileType c,cc,cpp,cxx,h,hpp nnoremap <leader>fI :LspImplementation<CR>
autocmd FileType c,cc,cpp,cxx,h,hpp nnoremap <leader>fR :LspReferences<CR>
autocmd FileType c,cc,cpp,cxx,h,hpp nnoremap <leader>fT :LspTypeDefinition<CR>
autocmd FileType c,cc,cpp,cxx,h,hpp nnoremap <leader>fM :LspTypeRename<CR>
...
hi Visual term=reverse ctermbg=147
